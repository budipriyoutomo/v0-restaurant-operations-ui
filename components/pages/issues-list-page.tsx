...
import { Search, Filter, Plus, AlertCircle, Clock, CheckCircle2, AlertTriangle, ChevronDown, X } from 'lucide-react'
            ...
            <div className="p-6 space-y-6">
              ...
              {selectedIssue.linkedModule && (
                <div className="space-y-2 pb-6 border-b border-border">
                  <p className="text-sm font-semibold">Linked Work Order</p>
                  <p className="text-sm font-mono font-bold text-primary bg-primary/10 px-3 py-2 rounded-md">
                    {selectedIssue.linkedModule}
                  </p>
                </div>
              )}
              ...
              <div className="flex flex-col gap-2 pt-6 border-t border-border">
                <button className="w-full px-4 py-2.5 rounded-md bg-primary text-primary-foreground text-sm font-semibold hover:bg-primary/90 transition-colors">
                  Update Status
                </button>
